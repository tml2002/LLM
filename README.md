...
{'dialog': ['我想问问今年体育部办的趣味运动会可以加综测嘛？', '可以的', '我们直接上传奖状就好了是嘛？', '应该是 我再问问需不需要体育部开证明', '好哒', '嗯嗯', '对了，还有八段锦也可以加分嘛', '可以的，凭奖状 不需要开证明', '那两个活动都是吗？', '对的', '要加的话是全体加主要成员还是一般成员呢？', '我问问哈', '好哒，谢谢啦', '没事', '姐妹这个趣味运动会你们那边能帮忙出证明嘛？', '可以按这个表填写，然后找老师盖章', '好哒，谢谢']}
